...
List<Note> mockNoteList = [
  Note(
      ...
      content:
          "Flutter is an open-source UI framework for creating native mobile applications."
          "It allows developers to build mobile applications a single codebase."),
  Note(
  ...
  Note(
      ...
      content:
          "The conditional (ternary) operator in Dart takes three operands: a condition, first expression (if truthy)"
          "and second expression (if falsy)."),
];
